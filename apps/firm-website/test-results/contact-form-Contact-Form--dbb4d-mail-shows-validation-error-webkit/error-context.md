...
- Name: contact-form.spec.ts >> Contact Form E2E Tests >> invalid email shows validation error
- Location: src\e2e\contact-form.spec.ts:20:3
...
- textbox "Message *":
  ...
  - text: This is a test message with enough characters
- button "Send Message"
